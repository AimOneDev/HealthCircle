...
class MedRecordPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _MedRecordPageState();
  }
}

class _MedRecordPageState extends State<MedRecordPage> {
  ...
  void _fetchMedRec() {
    http.get('https://health-circles.firebaseio.com/medicalrecords.json').then(
      (http.Response response) {
        ...
        Map<String, dynamic> medrecListData =
            json.decode(response.body);
        medrecListData
            .forEach((String medRecID, dynamic medrecData) {
          final MedicalRecord medRec = MedicalRecord(
            id: medRecID,
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              Image.asset('assets/img/mrecord.png',
